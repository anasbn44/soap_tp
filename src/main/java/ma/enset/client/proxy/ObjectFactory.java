 ...
 * generated in the ma.enset.client.proxy package. 
...
public class ObjectFactory {
    ...
    private static final QName _Compte_QNAME = new QName("http://ws.server.enset.ma/", "compte");
    private static final QName _Convert_QNAME = new QName("http://ws.server.enset.ma/", "convert");
    private static final QName _ConvertResponse_QNAME = new QName("http://ws.server.enset.ma/", "convertResponse");
    private static final QName _GetCompte_QNAME = new QName("http://ws.server.enset.ma/", "getCompte");
    private static final QName _GetCompteResponse_QNAME = new QName("http://ws.server.enset.ma/", "getCompteResponse");
    private static final QName _ListComptes_QNAME = new QName("http://ws.server.enset.ma/", "listComptes");
    private static final QName _ListComptesResponse_QNAME = new QName("http://ws.server.enset.ma/", "listComptesResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ma.enset.client.proxy
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://ws.server.enset.ma/", name = "compte")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.server.enset.ma/", name = "convert")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.server.enset.ma/", name = "convertResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.server.enset.ma/", name = "getCompte")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.server.enset.ma/", name = "getCompteResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.server.enset.ma/", name = "listComptes")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.server.enset.ma/", name = "listComptesResponse")
