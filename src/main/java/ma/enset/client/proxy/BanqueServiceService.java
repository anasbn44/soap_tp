 ...
 * 
 */
@WebServiceClient(name = "BanqueServiceService", targetNamespace = "http://ws.server.enset.ma/", wsdlLocation = "http://localhost:1997/?wsdl")
    ...
    extends Service
{
    ...
    private static final QName BANQUESERVICESERVICE_QNAME = new QName("http://ws.server.enset.ma/", "BanqueServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:1997/?wsdl");
    ...
    public BanqueService getBanqueServicePort() {
        return super.getPort(new QName("http://ws.server.enset.ma/", "BanqueServicePort"), BanqueService.class);
    }
    ...
    public BanqueService getBanqueServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.server.enset.ma/", "BanqueServicePort"), BanqueService.class, features);
    }
